				                	...
				                	<c:forEach items="${film_list_attribute }" var="filmItem">
										<tr>
											...
											<td>
												...
												<a class="btn  btn-sm btn-outline-primary ml-2 mr-2" href="${pageContext.request.contextPath}/film/preUpdate/${filmItem.id }">Edit</a>
												<a class="btn btn-outline-danger btn-sm" href="${pageContext.request.contextPath}/film/preDelete/${filmItem.id }">Delete</a>
											</td>
										</tr>
									</c:forEach>
				                </tbody>
