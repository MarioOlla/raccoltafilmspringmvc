			...
			<div class="container">
					...
					<div class='card'>
					    <div class='card-header'>
					        <h5>Aggiorna i valori del Film</h5> 
					    </div>
					    <div class='card-body'>
								...
								<form:form method="post" modelAttribute="toUpdate_film_attr" action="${ pageContext.request.contextPath}/film/update" novalidate="novalidate" class="row g-3">
								
									<input type="hidden" id="id" name="id" value="${toUpdate_film_attr.id }">
								
									<div class="col-md-6">
										<label for="titolo" class="form-label">Titolo <span class="text-danger">*</span></label>
										<spring:bind path="titolo">
											<input type="text" name="titolo" id="titolo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il titolo" value="${toUpdate_film_attr.titolo }">
										</spring:bind>
									...
									<div class="col-md-6">
										...
										<spring:bind path="genere">
											<input type="text" name="genere" id="genere" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il genere" value="${toUpdate_film_attr.genere }">
										</spring:bind>
										<form:errors  path="genere" cssClass="error_field" />
									</div>
									
									<div class="col-md-6">	
										<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date' value='${toUpdate_film_attr.dataPubblicazione}' />
									...
									<div class="col-md-6">
										...
										<spring:bind path="minutiDurata">
											<input type="number" class="form-control ${status.error ? 'is-invalid' : ''}" name="minutiDurata" id="minutiDurata" placeholder="Inserire la durata" value="${toUpdate_film_attr.minutiDurata }">
										</spring:bind>
									...
									<div class="col-md-6">
										...
										<spring:bind path="regista">
											<input class="form-control ${status.error ? 'is-invalid' : ''}" type="text" id="registaSearchInput"
												name="registaInput" value="${toUpdate_film_attr.regista.nome}${empty toUpdate_film_attr.regista.nome?'':' '}${toUpdate_film_attr.regista.cognome}">
										</spring:bind>
										<input type="hidden" name="regista.id" id="registaId" value="${toUpdate_film_attr.regista.id}">
